                    ...
                    <ul className='flex flex-col gap-4'>
                        <li className='flex flex-col w-72 gap-1'>
                            ...
                            <input id='name' ref={name} type='text'
                                   ...
                                   value={category && category.name} readOnly={false}/>
                        </li>
                        <li className='flex flex-col w-72 gap-1'>
                            <label htmlFor='image'>Upload Banner</label>
                            <input id='image' type='file' className='border-2 p-2 rounded-md outline-none'
                                   onChange={handleImage}/>
                        </li>
                    </ul>
                    <div className='flex gap-4 items-center mt-4'>
                        <Button className='text-lg py-2 px-4 rounded-md bg-cyan-700 text-white'
                                onClick={handleSubmitForm}>{loader && <Loader/>} Submit</Button>
